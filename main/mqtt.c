...
void mqtt5_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        esp_mqtt_client_publish(client, "/topic/pub-topic/", "Im here", 0, 1, 1);
        esp_mqtt5_client_delete_user_property(publish_property.user_property);
        publish_property.user_property = NULL;

        esp_mqtt_client_subscribe_single(client, "/topic/sub-topic/", 1);
        break;
    ...
    case MQTT_EVENT_SUBSCRIBED:
        ...
        esp_mqtt5_client_set_publish_property(client, &publish_property);
        esp_mqtt_client_publish(client, "/topic/pub-topic/", "I subscribed", 0, 1, 0);
        break;
